        ...
        <div className="service-page" style={{ padding: isMobileOrTablet ? '20px' : '40px', paddingTop: isMobile ? '80px' : '100px' }}>
            ...
            <div className="service-hero" style={{
                ...
                <div className="hero-text" style={{ marginBottom: isMobileOrTablet ? '20px' : '0', marginRight: isMobileOrTablet ? '0' : '20px' }}>
                    <h1 style={{
                        ...
                        Mercedes-Fahrzeuge Weltweit Verfügbar
                    </h1>
                    <p style={{ fontSize: isMobile ? '14px' : isMobileOrTablet ? '16px' : '1.1rem', lineHeight: '1.6' }}>
                        Entdecken Sie unser umfangreiches Angebot an Mercedes-Fahrzeugen, die zum Kauf und Versand weltweit bereitstehen.
                        Erleben Sie den Luxus und die Leistung von Mercedes, egal wo Sie sich befinden.
                    </p>
                </div>
                <div className="hero-image">
                    <img src={serviceImage} alt="Global Mercedes Service" style={{
                        width: '100%',
            ...
            <div className="service-content" style={{
                ...
                <p style={{ lineHeight: '1.6', marginBottom: '20px' }}>
                    Wir bieten eine umfassende Auswahl an Mercedes-Modellen, die jedem Geschmack gerecht werden, von eleganten Limousinen bis hin zu leistungsstarken SUVs.
                    Unser globaler Versandservice stellt sicher, dass Ihr Mercedes unabhängig von Ihrem Standort direkt vor Ihre Haustür geliefert wird.
                </p>
                ...
                <ul className="service-benefits" style={{ paddingLeft: isMobileOrTablet ? '15px' : '20px' }}>
                    <li style={{ fontSize: isMobile ? '14px' : '16px' }}>Große Auswahl der gebraucht Mercedes-Modelle</li>
            ...
            <div className="service-cta" style={{ marginTop: '30px', textAlign: 'center' }}>
                <p style={{
                    ...
                    Bereit, Ihren Traum-Mercedes zu besitzen?
                </p>
